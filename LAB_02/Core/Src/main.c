...
int main(void)
{
  ...
  /* Reset of all peripherals, Initializes the Flash inte rface and the Systick. */
  HAL_Init();
  ...
  //   HAL_Delay(1000);
    ...
    // // Compute Left-Hand Side and Right-Hand Side
    // int lhs = (a + b) * (a + b);
    // int rhs = (a * a) + (b * b) + (2 * a * b);
    
    // // Print the results using your custom function
    // myPrintf("a = %d, b = %d\r\n", a, b);
    // myPrintf("LHS: %d\r\n", lhs);
    // myPrintf("RHS: %d\r\n", rhs);
    
    // // Verify and print the conclusion
    // if (lhs == rhs) {
    ...
    // int key = 12345; // Placeholder for your encryption key
    // int len = strlen(str);
    ...
    // int A[2][2] = {{1, 2}, {3, 4}};
    // int B[2][2] = {{5, 6}, {7, 8}};
    // int C[2][2] = {{0, 0}, {0, 0}}; // Result matrix initialized to 0
